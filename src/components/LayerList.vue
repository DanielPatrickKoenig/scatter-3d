  ...
  methods: {
    ...
    onDraggerMove: function (e) {
      ...
      if (self.$data.dragging) {
        ...
        self.$data.draggedLayerPosition = this.filteredEventCoords(e, {x: 0, y: document.getElementById(self.$data.componentID).scrollTop - document.getElementsByTagName('html')[0].scrollTop - document.getElementById(self.$data.componentID).getBoundingClientRect().top - self.$data.yBuffer}).y
